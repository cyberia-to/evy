...
use root terms from the cybergraph, never aliases. particle not CID, neuron not user, cyberlink not edge. see [[cyberia/dev]] for the full rule + substitution table.
